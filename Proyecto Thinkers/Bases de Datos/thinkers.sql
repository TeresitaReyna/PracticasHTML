...
insert into ingresos (id_universidad, dp_nombre, dp_edad, dp_whatsApp, dp_email, dp_facebook, dp_domicilio, data_carrera,
	data_escuela, data_horario, data_razonIngreso, ref_saberNosotros, ref_nombreTutor, ref_telefonoTutor, id_curso) 
values (1, "Arath Martinez Vazquez", 18, "4861046581", "arathMartinez@hotmail.com", "https://facebook.com/Arath Martinez", 
	"Balcones del Valle", "Ingeniería en Sistemas Computacionales", "Cobach 20", "Vespertino (de 4:00 PM a 7:00 PM)",
    "Las oportunidades de esa universidad me interesan", "Unos amigos que han venido me recomendarón ingresar aquí para tomar cursos",
    "María Martinez", "4444532789", 1);
  
    
insert into ingresos (id_universidad, dp_nombre, dp_edad, dp_whatsApp, dp_email, dp_facebook, dp_domicilio, data_carrera,
	data_escuela, data_horario, data_razonIngreso, ref_saberNosotros, ref_nombreTutor, ref_telefonoTutor, id_curso) 
values (4, "Jessica Fernanda Lucio Niño", 18, "4443377467", "jessicaLucio@hotmail.com", "https://facebook.com/Jessica Lucio", 
	"Col. Colorines", "Ingeniería en Sistemas Computacionales", "Cobach 25", "Sabatino (de 8:00 AM a 4:00 PM)",
    "Las oportunidades de esa universidad me interesan", "Unos amigos que han venido me recomendarón ingresar aquí para tomar cursos",
    "Fernando Niño", "4441092299", 3);
...
select * from ingresos i left join universidades u on i.id_universidad = u.id;
select * from ingresos i left join cursos c on i.id_curso = c.id;
